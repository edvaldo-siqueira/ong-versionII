...
class VendasWindow(tk.Toplevel):
    def __init__(self, master):
        ...
        self.label_quantidade = tk.Label(self, text="Quantidade:")
        self.entry_quantidade = tk.Entry(self)
        self.button_vender = tk.Button(self, text="Vender", command=self.vender_peca, bg="#2196F3", fg="white")
...
class SobreWindow(tk.Toplevel):
    def __init__(self, master):
        ...
        desenvolvedores = [
            "1 Edvaldo da Silva Siqueira - 161151",
            "2 Heitor Santos Pimentel - 230966",
            "3 Karla Cristina Nascimento de Almeida - 255186",
            "4 Robinson Diego da Silva - 217431",
            "5 Karina Basso Punales - 228542",
            "6 André Alexandre Diedrich - 238532",
            "7 Gabriela da Silva Pinheiro - 216217",
            "8 Thiago Reis Silva - 222596",
            "9 Elton Amancio Santos - 243667",
            "10 Anne Karoline de Jesus Silva - 163568",
            "11 Ebenezer Guedes da Silva - 210891",
            "12 Nalanda Carmo Santos - 247486",
            "13 Luiz André Soares dos Santos - 238456",
            "14 Fábio Xavier Pacheco Miranda da Silva - 187188",
            "15 Renato Barbosa de Oliveira - 158707",
            "link do projeto no github   https://github.com/edvaldo-siqueira/ong-versionII",
        ]
